...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Index %d, Next Visible: %s", $hRandItem, _GUICtrlTreeView_GetNextVisible($hTreeView, $hItem[$hRandItem])))
	_GUICtrlTreeView_SelectItem($hTreeView, _GUICtrlTreeView_GetNextVisible($hTreeView, $hItem[$hRandItem]))
