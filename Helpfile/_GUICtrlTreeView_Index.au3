...
Func Example()
	...
	$iRand = Random(0, 29, 1)
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Index for Child Item %d: %d", $iRand, _GUICtrlTreeView_Index($hTreeView, $hChildItem[$iRand])))
	_GUICtrlTreeView_SelectItem($hTreeView, $hChildItem[$iRand])

	$iRand = Random(0, 9, 1)
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Index for Item %d: %d", $iRand, _GUICtrlTreeView_Index($hTreeView, $hItem[$iRand])))
