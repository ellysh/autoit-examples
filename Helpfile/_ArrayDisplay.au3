...
; If Obfuscator is to be used to strip unwanted functions then use this directive to make sure the user function is not removed
#Obfuscator_Ignore_Funcs=_UserFunc
