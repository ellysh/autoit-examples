...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("ImageList Icon Handle for Image %d: %s", $hRandomImage, _GUICtrlTreeView_GetImageListIconHandle($hTreeView, $hRandomImage)))
