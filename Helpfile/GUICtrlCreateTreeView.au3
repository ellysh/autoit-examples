...
Func Example()
	...
	$compinfo = GUICtrlCreateLabel("Name:" & @TAB & @ComputerName & @CRLF & "OS:" & @TAB & @OSVersion & @CRLF & "SP:" & @TAB & @OSServicePack, 120, 30, 200, 80)
		...
		Select
			...
			Case $msg = $infobutton
				...
				Else
					...
					Else
						MsgBox($MB_SYSTEMMODAL, "TreeView Demo", "Current item selected is: " & $text) ; $advmsg[0] contains the text and $advmsg[1] the state value of the treeview item
					EndIf
				EndIf
